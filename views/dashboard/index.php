              ...
              <div class="container">
                ...
                <div class="row">
                  <div class="col-sm-12">
                    ...
                    <div class="form-group">
                      <input type="text" name="volume" id="volume" class="form-control" placeholder="Course volume">                    </div>
                    <div class="form-group">
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="form-group">
                      <input class="form-control pri-btn-color" type="submit" value="Save the course"
