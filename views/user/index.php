            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="form-group">
                  ...
                  <input class="form-control pri-btn-color" type="submit" value="Create your account" style="background-color: #6dac29;font-weight: bold; border-radius:0px; color: #001;">
                </div>
              </div>
            </div>
          </div>
